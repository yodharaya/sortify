...
export default function BottomBar() {
  ...
  const menuItems = [
    { name: "Home", icon: "/all-page/bottom-bar/home.svg", path: "/" },
    {
      name: "Reward",
      icon: "/all-page/bottom-bar/reward.svg",
      path: "/reward",
    },
    {
      name: "History",
      icon: "/all-page/bottom-bar/history.svg",
      path: "/history",
    },
    {
      name: "Setting",
      icon: "/all-page/bottom-bar/setting.svg",
      path: "/setting",
    },
  ];
