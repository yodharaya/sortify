...
export default function ProfilePage() {
  ...
  const [username, setUsername] = useState("Marshall Ajunna");
  const [gender, setGender] = useState("Prefer not to say");
  const [profilePic, setProfilePic] = useState("/profile/default-pic.svg"); // Ganti dengan placeholder
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <div className="relative p-4 flex items-center justify-between">
        ...
        <Image src="/all-page/logo.svg" alt="Sortify Logo" width={100} height={36} />
